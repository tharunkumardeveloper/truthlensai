...
import { Upload, Play, Download, AlertTriangle, CheckCircle, Eye, BarChart3 } from 'lucide-react';
...
const DeepfakeDetectionPage: React.FC = () => {
  ...
  const tryDemo = () => {
    setVideoUrl('');
    setVideoFile(new File([], 'demo-video.mp4', { type: 'video/mp4' }));
    simulateProcessing();
  };
              ...
              >
                ...
                {!videoFile && (
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
                  >
                    Choose File
                  </button>
                )}

                {videoFile && !isProcessing && !analysisResult && (
                  <button
                    onClick={simulateProcessing}
                    className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-semibold text-lg hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center space-x-2 mx-auto"
                  >
